            ...
            <form action="{{route('disease.update', $disease->id)}}" method="POST" enctype="multipart/form-data" class="bg-slate-100 rounded-lg p-8">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 @error('name') border-red-600 @enderror" placeholder="Type New Disease name">
                        @error('name')
